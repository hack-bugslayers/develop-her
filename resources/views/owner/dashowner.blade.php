  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        ...
        <a href="account" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> EDIT ACCOUNT </a>
        ...
        <a href="/createprojectowner" class="list-group-item active main-color-bg"></span> CREATE PROJECT </a>
      </div>
