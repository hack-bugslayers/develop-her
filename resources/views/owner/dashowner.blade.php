  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        ...
        <!-- view profile link  -->
        <a href="users.html" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> VIEW MY PROFILE {{$user->username}}</a>

        <!-- practice coding link -->
        <a href="pages.html" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> CREATE PROJECT </a>
        </div>
