...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <!-- css: text-transform -->
                <div class="card-header"><strong>{{ __('CREATE A PROJECT') }}</strong></div>
               ...
               <div class="card-body">
                    <form method="POST" action={{ url('/createprojectowner/submit') }} aria-label="{{ __('Create Project') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="attachment" type="file" class="form-control{{ $errors->has('attachment') ? ' is-invalid' : '' }}" name="attachment" value="{{ old('attachment') }}" required autofocus>
